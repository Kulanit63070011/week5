...
@Route(value = "index2")
public class MyView_2 extends HorizontalLayout {
    ...
    public MyView_2(){
        ...
        cb1.setItems(new Word_2().goodWords);
        cb2.setItems(new Word_2().badWords);
        ...
        btn3.addClickListener(event -> {
            ...
            String result = WebClient
                    ...
                    .block();
            nf = Notification.show(result, 3000, TOP_CENTER);
        });

        btn4.addClickListener(event -> {
            Sentence_2 result = WebClient
                    .create()
                    .get()
                    .uri("http://localhost:8080/getSentence")
                    .retrieve()
                    .bodyToMono(Sentence_2.class)
                    .block();
